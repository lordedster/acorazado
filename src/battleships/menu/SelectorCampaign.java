...
public class SelectorCampaign 
    ...
    public SelectorCampaign(int cornerX, int cornerY, int width, int height, Menu.Listener l, double scaling, Resources r) {
        super(ITEM_COUNT, l);
        this.width = width;  
        this.height = height;
        ...
        mensaje = new StringImageItem("Perderá la campaña en curso/n    ¿Desea borrarla?");
